								...
								<div class="tab-content p-md">
										<?php foreach($product_language as $language): ?>
											...
											<div role="tabpanel" class="tab-pane in active fade <?php echo $language->title ?>_container" id="tab-1">
												...
												<div class="row">
													<div class="col-md-6 form-group " >
														<label for="<?php echo $language->title  ?>_product_meta_description">Türkçe Meta Description</label><br>
														<small class="d-block text-muted extra-small-text">
															Seo adresi girilmesi zorunlu değildir,girilen seo adresi geçerli olur.Girilmez ise otomatik olarak başllık kısmını referans alarak oluşturur.
														</small>
												...
												<div class="row">
													<div class="col-md-12 form-group " >
														<label for="<?php echo $language->title  ?>_product_video_embed">Türkçe Video Embed Kodu</label><br>
														<small class="d-block text-muted extra-small-text">
									...
									<div role="tabpanel" class="tab-pane fade" id="tab-2">
										<div class="row">
											<div class="col-md-6 form-group <?php echo (isset($form_error) ? (empty(set_value("product_code")) ? "has-error" :"") : "") ?>" >
												<label for="product_code"><span class="text-danger">*</span>Ürün Kodu</label><br>
												<small class="d-block text-muted extra-small-text">
													Ürün kodu.		
												</small>
										...
										<div class="row">
											<div class="col-md-6 form-group <?php echo (isset($form_error) ? (empty(set_value("product_amount")) ? "has-error" :"") : "") ?>" >
												<label for="product_amount"><span class="text-danger">*</span>Miktar</label><br>
												<small class="d-block text-muted extra-small-text">
													Üründen kaç adet olacağını belirler.Bu miktar 0 olarak girilirse "stokta yok" ibareleriyle listelenecektir.Eğer üründe seçenek varsa seçeneklerin stoğu ürün stoğundan büyük olamaz.		
												</small>
												<input type="number" class="form-control" id="product_amount" name="product_amount" value="<?php echo isset($form_error) ? set_value("product_amount") : (isset($item->product_amount) ? $item->product_amount : "") ?>">
												<?php if(isset($form_error)): ?>
										...
										<div class="form-group ">
											<label for="control-demo-6" class=""><span class="text-danger">*</span>Sepette Ekstra İndirim</label><br>
											<small class="d-block text-muted extra-small-text">
												Ürün sepet ekstra indirimde seçeneklere fiyat girilmiş ise indirim seçenek fiyatlarına da uygulanmaktadır. 			
											</small>
											<div id="control-demo-6" class="">
										...
										<div class="form-group ">
											<label for="control-demo-6" class=""><span class="text-danger">*</span>Vergi Oranı</label><br>
											<small class="d-block text-muted extra-small-text">
												Ürünün vergi oranı.			
											</small>
											<div id="control-demo-6" class="">
										...
										<div class="row">
											<div class="col-md-6 form-group" >
												<label ><span class="text-danger">*</span>Satış Fiyatı</label><br>
												<small class="d-block text-muted extra-small-text">
													Ürünün satış fiyatı.			
												</small>
												<div class="row">
										...
										<div class="form-group ">
											<label for="control-demo-6" class=""><span class="text-danger">*</span>Stoktan Düş</label><br>
											<small class="d-block text-muted extra-small-text">
												Ürün satıldıktan sonra ürün miktarı eksilir.				
											</small>
											<div id="control-demo-6" class="">
										...
										<div class="form-group ">
											<label for="control-demo-6" class=""><span class="text-danger">*</span>Durum</label><br>
											<small class="d-block text-muted extra-small-text">
												Ürünleri aktif veya pasif edin.				
											</small>
											<div id="control-demo-6" class="">
										...
										<div class="form-group ">
											<label for="control-demo-6" class=""><span class="text-danger">*</span>Özellik Bölümü</label><br>
											<small class="d-block text-muted extra-small-text">
												Ürünlerin özellik tabono gösterin yada göstermeyin.		
											</small>
											<div id="control-demo-6" class="">
										...
										<div class="row">
											<div class="col-md-6 form-group" >
												<label for="guarantee">Garanti Süresi</label><br>
												<small class="d-block text-muted extra-small-text">
													Ürün için verilen ay cinsinden garanti süresi.			
												</small>
									...
									<div role="tabpanel" class="tab-pane fade" id="tab-3">
										<div class="form-group image_upload_container" >
											<label for="exampleInputFile">Ürün Ana Resmi</label><br>
											<small class="d-block text-muted extra-small-text">
												Ürüne ana resim eklemek için tıklayın.<br>
												Ürün resmi eklerken kare resim girmelisiniz, önerilen boyut 800px genişlik, 800px yükseklik.<br>
												Ürün resmi eklerken maksimum resim boyutu 1MB ve genişlik 768px, yükseklik 1024px olmalıdır.
											</small>
											<div class="row">
												<div class="col-md-1">
